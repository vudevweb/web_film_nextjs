     ...
     return (  
          <nav className="navbar navbar-expand-lg fixed-top">
               <div className="container">
                    <a className="navbar-brand me-auto text-warning fw" href="/">Vudo</a>
                    <div className="offcanvas offcanvas-end" tabIndex={-1} id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                         ...
                         <div className="offcanvas-body">
                              <ul className="navbar-nav justify-content-center flex-grow-1 pe-3">
                                   ...
                                   <li className="nav-item">
                                        <a className="nav-link nav-link-vd  mx-lg-2" href="/danh-sach/phim-le">Phim Lẻ</a>
                                   </li>
                                   <li className="nav-item">
                                        <a className="nav-link nav-link-vd mx-lg-2" href="/danh-sach/phim-bo">Phim bộ</a>
                                   </li>
                                   {/* <li className="nav-item">
                                        <Link className="nav-link nav-link-vd mx-lg-2" href="/danh-muc/phim-dang-chieu">Phim đang chiếu</Link>
                                   </li> */}
                                   <li className="nav-item">
                                        <a className="nav-link nav-link-vd mx-lg-2" href="/danh-sach/hoat-hinh">Hoạt hình</a>
                                   </li>
                                   <li className="nav-item">
                                        <a className="nav-link nav-link-vd mx-lg-2" href="/danh-sach/tv-shows">TV Show</a>
                                   </li>
                                   <li className="nav-item dropdown">
                                        <a className="nav-link mx-lg-2 dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                             Thể loại
                                        </a>
                                        <ul className="dropdown-menu menu_vd">
                                             {theLoai.map((item, index) => (
                                                  <li key={index}><a className="dropdown-item" href={`/the-loai/${item.slug}`}>{item.name}</a></li>
                                             ))}
                                        </ul>
                                   </li>
                                   <li className="nav-item dropdown">
                                        ...
                                        <ul className="dropdown-menu menu_vd">
                                             {quocGia.map((item, index) => (
                                                  <li key={index}><a className="dropdown-item" href={`/quoc-gia/${item.slug}`}>{item.name}</a></li>
                                             ))}
                                        </ul>
                                   </li>
                                   <li className="nav-item dropdown">
                                        ...
                                        <ul className="dropdown-menu menu_vd">
                                             {namPhatHanh.map((item, index) => (
                                                  <li key={index}><a className="dropdown-item" href={`/nam-phat-hanh/${item.slug}`}>{item.name}</a></li>
                                             ))}
                                        </ul>
                                   </li>
                              </ul>
